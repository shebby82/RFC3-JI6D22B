DECLARE
	...
	VSQL35 VARCHAR2(32767);
	VSQL36 VARCHAR2(32767);
	VSQL37 VARCHAR2(32767);
	VSQL38 VARCHAR2(32767);
	VSQL39 VARCHAR2(32767);
	VSQL40 VARCHAR2(32767);
	VSQL41 VARCHAR2(32767);
	VSQL42 VARCHAR2(32767);
	VSQL43 VARCHAR2(32767);
	VSQL44 VARCHAR2(32767);
	VSQL45 VARCHAR2(32767);
	VSQL46 VARCHAR2(32767);
	VSQL47 VARCHAR2(32767);
	VSQL48 VARCHAR2(32767);
	VSQL49 VARCHAR2(32767);
	VSQL50 VARCHAR2(32767);
	VSQL51 VARCHAR2(32767);
	VSQL52 VARCHAR2(32767);
...
BEGIN 
	...
	VSQL1 := '
		DELETE FROM AsRole
		WHERE ClientGUID IN (
			SELECT ClientGUID FROM AsClient WHERE CompanyName IN (''Ultra Re'', ''Optimum Reinsurance Company'', ''Hannover Reinsurance Company'', ''SCOR Reinsurance Company'', ''RGA Reinsurance Company'', ''Swiss Reinsurance Company'', ''Partner Reinsurance Company'', ''GenRe Reinsurance Company'', ''Munich Reinsurance Company'')
			)
			AND RoleCode = ''02''
		';
	...
	-- Insert Hannover Reinsurance Company
	VSQL11 := '
		INSERT INTO AsClient (ClientGUID, TypeCode, CompanyName, UpdatedGMT, LegalResidenceCountryCode, EntityTypeCode)
		VALUES (''348B5635-A41B-07DA-E063-030012AC4D4E'', ''20'', ''Hannover Reinsurance Company'', TO_TIMESTAMP(''10/1/2019 00:00:00'',''mm/dd/yyyy HH24:MI:SS''), ''CA'', ''GROUPCUST'')
		';

	VSQL12 := '
		INSERT INTO AsGroupCustomer (GroupCustomerGUID, ClientGUID, PrimaryEnrollmentRelationship, EnrollmentClassGroup, HierarchyRelationship)
		VALUES (''348B5635-A425-07DA-E063-030012AC4D4E'',''348B5635-A41B-07DA-E063-030012AC4D4E'',''CONTACT'',''03'',''CONTACT'')
		';

	VSQL13 := '
		INSERT INTO AsRole (RoleGUID, CompanyGUID, ClientGUID, RoleCode)
		VALUES (''348B5635-A427-07DA-E063-030012AC4D4E'', ''8E431317-BD23-480E-AA50-CE2F9BBAF3DE'', ''348B5635-A41B-07DA-E063-030012AC4D4E'', ''02'')
		';

	VSQL14 := '
		INSERT INTO AsClientField (ClientGUID, FieldName, FieldTypeCode, IntValue)
		VALUES (''348B5635-A41B-07DA-E063-030012AC4D4E'', ''CompanyReinsuranceLimit'', ''03'', 999999999)
		';
		
	VSQL15 := '
		INSERT INTO AsClientField (ClientGUID, FieldName, FieldTypeCode, DateValue)
		VALUES (''348B5635-A41B-07DA-E063-030012AC4D4E'', ''OriginalEffectiveDate'', ''01'', TO_TIMESTAMP(''10/1/2019 00:00:00'',''mm/dd/yyyy HH24:MI:SS''))
		';
		
	VSQL16 := '
		INSERT INTO AsClientField (ClientGUID, FieldName, FieldTypeCode, IntValue)
		VALUES (''348B5635-A41B-07DA-E063-030012AC4D4E'', ''ReinsurerNumber'', ''03'', 43)
		';
	...
	-- Insert Swiss Reinsurance Company
	VSQL29 := '
		INSERT INTO AsClient (ClientGUID, TypeCode, CompanyName, UpdatedGMT, LegalResidenceCountryCode, EntityTypeCode)
		VALUES (''348B5635-A42C-07DA-E063-030012AC4D4E'', ''20'', ''Swiss Reinsurance Company'', TO_TIMESTAMP(''10/1/2019 00:00:00'',''mm/dd/yyyy HH24:MI:SS''), ''CA'', ''GROUPCUST'')
		';

	VSQL30 := '
		INSERT INTO AsGroupCustomer (GroupCustomerGUID, ClientGUID, PrimaryEnrollmentRelationship, EnrollmentClassGroup, HierarchyRelationship)
		VALUES (''348B5635-A431-07DA-E063-030012AC4D4E'',''348B5635-A42C-07DA-E063-030012AC4D4E'',''CONTACT'',''03'',''CONTACT'')
		';

	VSQL31 := '
		INSERT INTO AsRole (RoleGUID, CompanyGUID, ClientGUID, RoleCode)
		VALUES (''348B5635-A436-07DA-E063-030012AC4D4E'', ''8E431317-BD23-480E-AA50-CE2F9BBAF3DE'', ''348B5635-A42C-07DA-E063-030012AC4D4E'', ''02'')
		';

	VSQL32 := '
		INSERT INTO AsClientField (ClientGUID, FieldName, FieldTypeCode, IntValue)
		VALUES (''348B5635-A42C-07DA-E063-030012AC4D4E'', ''CompanyReinsuranceLimit'', ''03'', 999999999)
		';
		
	VSQL33 := '
		INSERT INTO AsClientField (ClientGUID, FieldName, FieldTypeCode, DateValue)
		VALUES (''348B5635-A42C-07DA-E063-030012AC4D4E'', ''OriginalEffectiveDate'', ''01'', TO_TIMESTAMP(''10/1/2019 00:00:00'',''mm/dd/yyyy HH24:MI:SS''))
		';
		
	VSQL34 := '
		INSERT INTO AsClientField (ClientGUID, FieldName, FieldTypeCode, IntValue)
		VALUES (''348B5635-A42C-07DA-E063-030012AC4D4E'', ''ReinsurerNumber'', ''03'', 15)
		';
	...
	-- Insert GenRe Reinsurance Company
	VSQL41 := '
		INSERT INTO AsClient (ClientGUID, TypeCode, CompanyName, UpdatedGMT, LegalResidenceCountryCode, EntityTypeCode)
		VALUES (''348B5635-A43B-07DA-E063-030012AC4D4E'', ''20'', ''GenRe Reinsurance Company'', TO_TIMESTAMP(''10/1/2019 00:00:00'',''mm/dd/yyyy HH24:MI:SS''), ''CA'', ''GROUPCUST'')
		';

	VSQL42 := '
		INSERT INTO AsGroupCustomer (GroupCustomerGUID, ClientGUID, PrimaryEnrollmentRelationship, EnrollmentClassGroup, HierarchyRelationship)
		VALUES (''348B5635-A43F-07DA-E063-030012AC4D4E'',''348B5635-A43B-07DA-E063-030012AC4D4E'',''CONTACT'',''03'',''CONTACT'')
		';

	VSQL43 := '
		INSERT INTO AsRole (RoleGUID, CompanyGUID, ClientGUID, RoleCode)
		VALUES (''348B5635-A443-07DA-E063-030012AC4D4E'', ''8E431317-BD23-480E-AA50-CE2F9BBAF3DE'', ''348B5635-A43B-07DA-E063-030012AC4D4E'', ''02'')
		';

	VSQL44 := '
		INSERT INTO AsClientField (ClientGUID, FieldName, FieldTypeCode, IntValue)
		VALUES (''348B5635-A43B-07DA-E063-030012AC4D4E'', ''CompanyReinsuranceLimit'', ''03'', 999999999)
		';
		
	VSQL45 := '
		INSERT INTO AsClientField (ClientGUID, FieldName, FieldTypeCode, DateValue)
		VALUES (''348B5635-A43B-07DA-E063-030012AC4D4E'', ''OriginalEffectiveDate'', ''01'', TO_TIMESTAMP(''10/1/2019 00:00:00'',''mm/dd/yyyy HH24:MI:SS''))
		';
		
	VSQL46 := '
		INSERT INTO AsClientField (ClientGUID, FieldName, FieldTypeCode, IntValue)
		VALUES (''348B5635-A43B-07DA-E063-030012AC4D4E'', ''ReinsurerNumber'', ''03'', 45)
		';
	...
	EXECUTESQL ( VSQL35, VRESULT );
	EXECUTESQL ( VSQL36, VRESULT );
	EXECUTESQL ( VSQL37, VRESULT );
	EXECUTESQL ( VSQL38, VRESULT );
	EXECUTESQL ( VSQL39, VRESULT );
	EXECUTESQL ( VSQL40, VRESULT );
	EXECUTESQL ( VSQL41, VRESULT );
	EXECUTESQL ( VSQL42, VRESULT );
	EXECUTESQL ( VSQL43, VRESULT );
	EXECUTESQL ( VSQL44, VRESULT );
	EXECUTESQL ( VSQL45, VRESULT );
	EXECUTESQL ( VSQL46, VRESULT );
	EXECUTESQL ( VSQL47, VRESULT );
	EXECUTESQL ( VSQL48, VRESULT );
	EXECUTESQL ( VSQL49, VRESULT );
	EXECUTESQL ( VSQL50, VRESULT );
	EXECUTESQL ( VSQL51, VRESULT );
	EXECUTESQL ( VSQL52, VRESULT );
